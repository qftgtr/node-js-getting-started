;(function () {
	...
	var cubeAnimate = function() {
		...
		if ( $('#the-cube').length > 0 ) {
			$('#the-cube .to-animate').each(function( k ) {
	...
	var cubeWayPoint = function() {

		if ( $('#the-cube').length > 0 ) {
			$('#the-cube').waypoint( function( direction ) {

				if( direction === 'down' && !$(this).hasClass('animated') ) {


					setTimeout(cubeAnimate, 200);
	...
	// App
	var appAnimate = function() {

		if ( $('#officewell-app').length > 0 ) {
			$('#officewell-app .to-animate').each(function( k ) {
	...
	var appWayPoint = function() {

		if ( $('#officewell-app').length > 0 ) {
			$('#officewell-app').waypoint( function( direction ) {

				if( direction === 'down' && !$(this).hasClass('animated') ) {


					setTimeout(appAnimate, 200);
	...
	var enterpriseAnimate = function() {
		...
		if ( $('#enterprise-analysis').length > 0 ) {
			$('#enterprise-analysis .to-animate').each(function( k ) {
	...
	var enterpriseWayPoint = function() {

		if ( $('#enterprise-analysis').length > 0 ) {
			$('#enterprise-analysis').waypoint( function( direction ) {

				if( direction === 'down' && !$(this).hasClass('animated') ) {


					setTimeout(enterpriseAnimate, 200);
	...
	// Cooperation
	var cooperateAnimate = function() {

		if ( $('#cooperate').length > 0 ) {
			$('#cooperate .to-animate').each(function( k ) {
	...
	var cooperateWayPoint = function() {

		if ( $('#cooperate').length > 0 ) {
			$('#cooperate').waypoint( function( direction ) {

				if( direction === 'down' && !$(this).hasClass('animated') ) {


					setTimeout(cooperateAnimate, 200);
